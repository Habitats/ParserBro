...
public class ImdbParser extends NoCookieParser {
	...
	public Movie getImdbInfo(String movieTitle) throws Exception {
		String apiUrl = "http://mymovieapi.com/?type=xml&plot=simple&episode=1&limit=1&yg=0&mt=none&lang=en-US&offset=&aka=simple&release=simple&business=0&tech=0&title=" + movieTitle;
