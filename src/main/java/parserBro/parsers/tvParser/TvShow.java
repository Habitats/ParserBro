...
public class TvShow {
  ...
  public TvShow(String id, String title, Date started, Date ended, String status, String runtime, String country,
                String classification, String network, String url, String imageUrl) {
    this.id = id;
    this.title = title;
  ...
  private String getLatestEpisode() {
    ...
    try {
      return DateMgmt.getFormattedDate(latestEpisode.getAirTime()) + " " + DateMgmt
          .getFormattedAirTime(latestEpisode.getAirTime()) + " (" + DateMgmt
                 .getFormattedSinceDate(latestEpisode.getAirTime()) + " ago)";
    } catch (Exception e) {
  ...
  private String getNextEpisode() {
    try {
      return DateMgmt.getFormattedDate(nextEpisode.getAirTime()) + " " + DateMgmt
          .getFormattedAirTime(nextEpisode.getAirTime()) + " (in " + DateMgmt
                 .getFormattedTilDate(nextEpisode.getAirTime()) + ")";
    } catch (Exception e) {
      return "TBA";
    }
  }
